...
//*********************************************Updated Code after adding proguard************************************/
package com.example.sdk_connection_2;
...
// Import the DeviceManager class from the ICDeviceManager SDK
import com.example.ICDemo.DeviceManager;
...
public class MainActivity extends FlutterActivity {
                ...
                .setMethodCallHandler(
                    new MethodChannel.MethodCallHandler() {
                        ...
                        public void onMethodCall(MethodCall call, MethodChannel.Result result) {
                            if (call.method.equals("initializeDeviceManager")) {
                                initializeDeviceManager();
                                result.success("Device Manager Initialized");
                            } else {
                                result.notImplemented();
                            }
                        }
    ...
    private void initializeDeviceManager() {
        // Initialize DeviceManager from the ICDeviceManager SDK
