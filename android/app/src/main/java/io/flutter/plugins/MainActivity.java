...
//Updated code to resolve error in discover services, screen5
// package com.example.sdk_connection_2;
...
//     // Comprehensive list of potential weight-related service UUIDs
//     private final List<String> weightServiceUuids = Arrays.asList(
//         "0000ffb0-0000-1000-8000-00805f9b34fb",  // Weight Scale Service
//         "00001530-1212-efde-1523-785feabcd123",  // Custom device service
//         "0000ffb0-0000-1000-8000-00805f9b34fb"   // Another potential service
//     );
...
//         // Use Map<String, List<Map<String, String>>> to ensure compatibility with Flutter
//         Map<String, List<Map<String, String>>> serviceMap = new HashMap<>();
        
//         for (BluetoothGattService service : gatt.getServices()) {
//             String serviceUuid = service.getUuid().toString();
//             List<Map<String, String>> characteristicsList = new ArrayList<>();
            
//             for (BluetoothGattCharacteristic characteristic : service.getCharacteristics()) {
//                 // Create a map for each characteristic's UUID and other relevant data
//                 Map<String, String> characteristicMap = new HashMap<>();
//                 characteristicMap.put("uuid", characteristic.getUuid().toString());
                
//                 // Optionally, you can add more information about the characteristic here
//                 // characteristicMap.put("someOtherKey", someOtherValue);

//                 characteristicsList.add(characteristicMap);
//             }
            
//             serviceMap.put(serviceUuid, characteristicsList);
//         }
...
//             result.success("Services discovery started");
//         } else {
...
//*************updated code with dynamic uuids , screen 5 */
// package com.example.sdk_connection_2;
...
//                 // Dynamically discover weight-related services and characteristics
//                 Map<String, List<Map<String, String>>> serviceMap = new HashMap<>();
//                 for (BluetoothGattService service : gatt.getServices()) {
//                     String serviceUuid = service.getUuid().toString();
//                     List<Map<String, String>> characteristicsList = new ArrayList<>();
...
//                     // Add the service and its characteristics to the map
//                     serviceMap.put(serviceUuid, characteristicsList);
//                 }

//                 // Send the discovered services to Flutter
//                 sendToFlutterOnMainThread("onServicesDiscovered", serviceMap);
//             } else {
//                 Log.e(TAG, "onServicesDiscovered received: " + status);
//             }
...
//             // Check if service matches specified or discovered service UUIDs
//             if (specifiedServiceUuid != null && serviceUuid.equals(specifiedServiceUuid.toUpperCase())) {
//                 for (BluetoothGattCharacteristic characteristic : service.getCharacteristics()) {
//                     String characteristicUuid = characteristic.getUuid().toString().toUpperCase();

//                     // Check if characteristic matches specified or discovered characteristic UUIDs
//                     if (specifiedCharacteristicUuid != null && characteristicUuid.equals(specifiedCharacteristicUuid.toUpperCase())) {
//                         int properties = characteristic.getProperties();
...
//***************************Updated code to resolve the uuid pattern not matched error of screen 3**************************/
package com.example.sdk_connection_2;
...
public class MainActivity extends FlutterActivity {
    ...
    private static final UUID CHARACTERISTIC_NOTIFY_UUID = UUID.fromString("0000ffb2-0000-1000-8000-00805f9b34fb");
    private static final UUID CHARACTERISTIC_WRITE_UUID = UUID.fromString("00001531-1212-efde-1523-785feabcd123");
    ...
    private void enableNotifications(BluetoothGatt gatt) {
        BluetoothGattCharacteristic notifyCharacteristic = gatt.getService(SERVICE_UUID)
    ...
    private float parseWeightData(byte[] data) throws Exception {
        if (data.length >= 4) {
            ByteBuffer buffer = ByteBuffer.wrap(data).order(ByteOrder.LITTLE_ENDIAN);
    ...
    private void getWeightData(MethodChannel.Result result) {
        ...
        if (service != null) {
            ...
            if (characteristic != null) {
                ...
                result.success("Weight data notifications enabled.");
                return;
            }
        }
        result.error("NO_WEIGHT_CHARACTERISTIC", "No suitable weight characteristic found", null);
